...
md"""
- Best seting: n\_subfeatures=3, max\_depth=8.
- RMS=0.359411. 
"""
...
# ╔═╡ 8ceb3172-c737-485c-8b11-8af3ab24d263
md"""
Testing on DS2
"""

# ╔═╡ 99599518-ea01-4b1a-86b6-0c58f49e9d2c
begin
	yhat = predict(m3, select(DS2_bin, Not(:num)))
	rms(yhat, DS2_bin[:,:num])
end
